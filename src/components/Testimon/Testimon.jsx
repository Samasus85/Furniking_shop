...
const Testimon = () => {
  return (
    <div className={css.container}>
      <div >
        <h2 className={css.title}>What Our Customer Says </h2>
        <div className={css.content}>
          <div className={css.block} >
            <div className={css.avatar}>
              <div><span>Alla Pugacheva </span>
                <span className={css.date}>February 20, 2022</span>
              </div>
          ...
          <div className={css.block} >
            <div className={css.avatar}>
              <div><span>Angelina Joly </span>
                <span className={css.date}>May 18, 2022</span>
              </div>
          ...
          <div className={css.block} >
            <div className={css.avatar}>
              <div><span>Britney Spears </span>
                <span className={css.date}>January 28, 2022</span>
              </div>
